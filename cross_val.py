...
def generate_embeddings_train_predict(corpora, corpora_predict, outputpath):
    ...
    for i in range(246, 256):
        ...
        score = cross_val_score(rf, two_paragraphs_embeddings_list, two_paragraphs_label_list, cv=10).mean()
        scores_2.append(score)
    print(max(scores_2), scores_2.index(max(scores_2)) + 246)
    plt.plot(range(246, 256), scores_2)
    plt.show()
...
if __name__ == '__main__':
    input_train = 'demo_data20/train1'
    input_val = 'demo_data20/validation'
    output_dir = 'task2_result'
