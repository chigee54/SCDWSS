...
3. 此代码还未完成，只完成了task1，task2和task3还未跑通(所以代码里面有关task2，task3的暂时被注释掉了，先测试task1)
'''
...
def generate_embeddings_train_predict(corpora, corpora_predict, outputpath):
    ...
    for document_path in corpora:
        ...
        for paragraph_index, paragraph in enumerate(paragraphs):
            ...
            # line_para_embeddings = embed_add / paragraph_index
            # paragraphs_embeddings.append()
        ...
        # separate_label_list.append(separate_label)
        ...
        if document_id == 0:
            ...
            # paragraphs_label_list = np.append(paragraphs_label_list, array_para_label)
        ...
        # paragraphs_embeddings_list.append(paragraphs_embeddings)
    ...
    print(separate_label_list)
    print(paragraphs_embeddings_list)
...
if __name__ == '__main__':
    ...
    input_val = 'demo_data20/validation'
    output_dir = 'demo_solve'
    ...
    # for k, v in {
    #     'task1_score': task1_results,
    #     'task2_score': task2_results}.items():
    #     write_output(os.path.join(output_dir, "evaluation.txt"), k, v)
