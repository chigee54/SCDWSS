...
valid_data = data_load(validation_path)
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if val_acc > self.best_val_acc:
            ...
            model.save_weights('finetune_pro/best_model.weights')
            model.save('finetune_pro/best_model.h5')
...
if __name__ == '__main__':
    model = load_model('finetune_change/best_model.h5')
    ...
    model.load_weights('finetune_pro/best_model.weights')
    with open('finetune_pro/result.txt', 'a', encoding='utf-8') as result_file:
